                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="content">
                            ...
                            <h1 className='head'>Quality with Excellence</h1>
                    ...
                    <div className="col-lg-6">
                        <div className="images">
                            <Image width={1000} height={1000} src="/images/steel2.webp" className='img1 img-fluid' alt=""  priority={true} loading="eager" />
                            <Image width={1000} height={1000} src="/images/ourProducts.webp" className='img2 img-fluid' alt="" priority={true} loading="eager" />
                        </div>
                    </div>
                </div>
            </div>
