                        ...
                        <div className="col-lg-6">
                            <div className="images">
                                <div className="images-1">
                                    <Image width={1000} height={1000} src="/images/ourProducts.webp" className='img img-fluid' alt="" />
                                    <Image width={1000} height={1000} src="/images/services.webp" className='img img-fluid' alt="" />
                                </div>
                                <div className="images-2">
                                    <Image width={1000} height={1000} src="/images/product1.webp" className='img img-fluid' alt="" />
                                    <Image width={1000} height={1000} src="/images/Home1.webp" className='img img-fluid' alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
