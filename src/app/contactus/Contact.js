                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-12">
                        <form onSubmit={handleSubmit} className={styles.form_container}>
                            ...
                            <div className="input-field">
                                <input type="text" className='phone' onChange={(e) => { handleFocus(2, e); handleChange(e) }} name='phone' required />
                            ...
                            <div className="input-field">
                                <textarea name="message" id="message" rows={4} onChange={(e) => { handleFocus(4, e); handleChange(e) }} required />
