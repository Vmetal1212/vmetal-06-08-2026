...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    createScrollTrigger(
      `.${styles.contact} .${styles.form_container}`,
      ` .input-field`,
      200,
      3,
    );
        ...
        <div className="row">
          <div className="col-md-6 col-12">
            <div className={`${styles.item} ${styles.address}`}>
              <div className={styles.item_content}>
                ...
                <div className="d-flex flex-column">
                  <Link href={"https://maps.app.goo.gl/exQQKfuGKcZnjzPi8"}>
                    ...
                    <p>
                      523, First Floor, Road No. 14, Kathwada G.I.D.C.,
                  ...
                  >
                    ...
                    >
                      <Link
                        href="tel:+919510215623"
                        style={{ textDecoration: "none", color: "inherit" }}
                      >
                          <HiOutlinePhone className={styles.icon} />
                        <p style={{ margin: 0 }}>+91 95102 15623</p>
                      </Link>

                      <span>/</span>

                      <Link
                        href="tel:+919510978202"
                        style={{ textDecoration: "none", color: "inherit" }}
                      >
                        <p style={{ margin: 0 }}>+91 95109 78202</p>
                      </Link>
                    </div>
                  </div>
                </div>
              ...
              >
                <path
                  d="M222.019 0L147.842 75.6216L184.861 113.377L222.009 75.4997L407.205 264.325L444.234 226.57L222.019 0Z"
                  fill="#103769"
                ></path>
                <path
                  d="M110.843 119.365L-0.234375 232.62L36.7947 270.375L110.843 194.865L184.742 270.212L221.801 232.427L110.843 119.365Z"
                  fill="#103769"
                ></path>
              </svg>
            </div>
            ...
            <div className={`${styles.item} ${styles.map}`}>
              <div className={styles.item_content}>
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.860189027688!2d72.68000687412913!3d23.028905116094105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e870f7682eea3%3A0x8520939c289f701e!2sV%20Metal%20Solutions%20inc!5e0!3m2!1sen!2sin!4v1722621135856!5m2!1sen!2sin"
                  allowfullscreen=""
                  loading="lazy"
            ...
            <form onSubmit={handleSubmit} className={styles.form_container}>
              <div className="input-field">
                <input
                  ...
                  required
                />
                <label htmlFor="name" className={focus[0] ? "on-focus" : null}>
                  Name
                </label>
              </div>
              <div className="input-field">
                <input
                  ...
                  required
                />
                <label htmlFor="email" className={focus[1] ? "on-focus" : null}>
                  Email
                </label>
              </div>
              <div className="input-field">
                <input
                  ...
                  required
                />
                <label htmlFor="phone" className={focus[2] ? "on-focus" : null}>
                  Phone Number
                </label>
              </div>
              <div className="input-field">
                ...
                <label
                  htmlFor="subject"
                  className={focus[3] ? "on-focus" : null}
                >
                  Subject
                </label>
              </div>
              <div className="input-field">
                ...
                <label
                  htmlFor="message"
                  className={focus[4] ? "on-focus" : null}
                >
                  Message
                </label>
              </div>
              ...
              {success.text !== "" ? (
                <p
                  className="mb-1 mt-0"
                  style={
                    success.success ? { color: "green" } : { color: "red" }
                  }
                >
                  {success.text}
                </p>
              ...
              <div className="mt-3">
                ...
                <a
                  target="_blank"
                  href={"/images/Vmetal_brocher.pdf"}
                  className="button2 ms-2 mb-0 rounded-0"
                  style={{ color: "#fff" }}
                >
                  <BiSolidDownload className="me-2" /> E Brochure
                </a>
              </div>
            </form>
          </div>
