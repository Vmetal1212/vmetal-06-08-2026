...
const ProductDetail = ({ products, applications }) => {
  ...
  return (
    <>
      <div className="container-fluid padd-x">
        <div className={styles.hero}>
          ...
          <div className="row align-items-center">
            <div
              className="col-xl-5 col-12 p-0 order-xl-0 order-1"
              style={{ height: "auto" }}
            >
        ...
        <div className={styles.content_container}>
          {products.attributes?.title2 && <h2>{products.attributes.title2}</h2>}

          {products.attributes?.title3 && <p>{products.attributes.title3}</p>}
          {products.attributes &&
            ...
            <div className="row my-3 mt-5" style={{ height: "100%" }}>
              ...
              <div className="col-lg-8 col-12 mt-lg-0 mt-3">
                {products.attributes &&
                  ...
                  (() => {
                    const text = products.attributes.newDescription;
              ...
              >
                {mild.map((item, index) => (
                  <SwiperSlide key={index}>
                    <Link href={item.slug} className={styles.mild}>
                ...
                <div className={styles.boximage}>
                  <div className="d-flex align-items-center justify-content-center h-100 w-100">
                    <Image
                      ...
                      width={1000}
                      height={1000}
                      src={item.img || "/images/construction1.svg"}
      ...
      <Brands
        subtitle={"Brands Supplied"}
        title={products.attributes && products.attributes.title1}
      />
    </>
  );
};
