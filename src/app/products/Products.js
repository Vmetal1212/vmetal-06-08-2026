                    ...
                    <div className={styles.hero}>
                        ...
                        <div className={styles.hero_right}>
                            <div className={styles.content}>
                                <h1>Quality Steel for Every Project</h1>
                                <p className="mb-1">V Metal Solutions Inc of Steel is manufacturing and merchanting highly contributes to various processes by giving their customers mild steel sheets, coils, slitted coils and corrugated sheets as per their requirements and specifications.</p>
                                <p> Mainly the mild steel products (CR/CRCA, HR/HRPO, GP/GI, PPGI/PPGL, PMP, Z/C Purlin) are manufactured in various forms and are delivered to various companies.</p>
